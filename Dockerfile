...
ADD \
  ...
  ./
EXPOSE 25565
RUN ["java", "-jar", "forge-1.10.0-12.18.0.2000-1.10.0-installer.jar","-installServer"]
RUN ["rm","forge-1.10.0-12.18.0.2000-1.10.0-installer.jar"]
RUN ["rm","forge-1.10.0-12.18.0.2000-1.10.0-installer.jar.log"]
CMD ["java", "-jar", "forge-1.10.0-12.18.0.2000-1.10.0-universal.jar","nogui"]
